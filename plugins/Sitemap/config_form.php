...
echo get_view()->formCheckbox('xml_sitemap_include_simple_pages', true, 
...
echo get_view()->formCheckbox('xml_sitemap_include_tags', true, 
...
echo get_view()->formCheckbox('xml_sitemap_include_category_browser', true, 
...
echo get_view()->formCheckbox('xml_sitemap_include_exhibits', true, 
